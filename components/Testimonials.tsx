    ...
    <section className="py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900">Quem usa, ama ✨</h2>
          <p className="mt-4 text-slate-600">Junte-se a mais de 50.000 pessoas descobrindo seu brilho.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg hover:shadow-pink-500/5 transition-all duration-300"
            >
